...
class Test_class():
    ...
    def test_main(self, case, description, httpParameters):
        ...
        if httpParameters["paramType"] == "string":
            ...
            urlPath2 = urlPath + stringParams + "/editEffectiveEndTime?" + "effectiveEndTime=2021-07-31T06%3A37%3A31.008Z&isPermanent=false&lastModifiedUser=admin"
    ...
    def test_all(self, case, description, httpParameters):
        ...
        if httpParameters["paramType"] == "string":
            stringParams = jsonAnalysis.getStringParams(httpParameters["query"])
            urlPath2 = urlPath + stringParams + "/editEffectiveEndTime?" + "effectiveEndTime=2021-07-31T06%3A37%3A31.008Z&isPermanent=true&lastModifiedUser=afeng"
            postJ = httpApi.httpRequests(urlIP, urlPath2, httpParameters["httpType"])
        elif httpParameters["paramType"] == "json":
    ...
    def test_all(self, case, description, httpParameters):
        ...
        if httpParameters["paramType"] == "string":
            stringParams = jsonAnalysis.getStringParams(httpParameters["query"])
            urlPath2 = urlPath + stringParams + "/editEffectiveEndTime?" + "effectiveEndTime=2021-07-31T06%3A37%3A31.008Z&isPermanent=false&lastModifiedUser=afengda"
            postJ = httpApi.httpRequests(urlIP, urlPath2, httpParameters["httpType"])
        elif httpParameters["paramType"] == "json":
            urlPath3 = urlPath + "?lastModifiedUser=afeng"
            postJ = httpApi.httpRequests(urlIP, urlPath3, httpParameters["httpType"], parame=httpParameters["query"])
