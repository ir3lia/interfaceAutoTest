...
controllerName = "OAuthController"
interfaceChName = "添加SSO对接配置"
interfaceEnName = "addSSO"
...
urlPath = authenticationApiPaths[0]['getAllSSO']
...
class Test_class():
    ...
    def test_main(self, case, description, httpParameters):
        ...
        if httpParameters["paramType"] == "string":
            ...
            postJ = httpApi.httpRequests(urlIP, urlPath, httpParameters["httpType"])
        else:
