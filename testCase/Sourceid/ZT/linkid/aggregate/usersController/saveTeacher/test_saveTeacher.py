...
interfaceChName = "保存教职工接口"
interfaceEnName = "savaTeacher"
...
urlPath = linkidApiPaths[0]['aggregateSaveTeacher']
...
class Test_class():
    ...
    def test_main(self, case,description, httpParameters):
        ...
        if httpParameters["paramType"] == "string":
            ...
            urlPath2 = urlPath + '/' + httpParameters["pageId"]
            postJ = httpApi.httpRequests(urlIP,urlPath2,httpParameters["httpType"],parame=httpParameters["query"])
        else:
